...
InfoScreen::InfoScreen(TFT_eSPI* pTft, reflow_esp::Thermocouple* pTc1, reflow_esp::Thermocouple* pTc2) {
  mpTft = pTft;
  mpTc1 = pTc1;
  mpTc2 = pTc2;
}

void InfoScreen::loop() {
  if(gCurrentScreen != SCREEN_ID_INFO) return;
